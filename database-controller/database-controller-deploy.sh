...
execute_and_exit_on_failure docker buildx build --platform linux/amd64,linux/arm64 -f dockerfile.api -t registry.rydersel.cloud/database-api-controller . --push
execute_and_exit_on_failure docker buildx build --platform linux/amd64,linux/arm64 -f dockerfile.sync -t registry.rydersel.cloud/database-sync-controller . --push
