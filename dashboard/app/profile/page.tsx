...
import { Trophy, Medal, Target, Flag, Calendar, User, Star } from 'lucide-react';
                        ...
                        <TabsContent value="activity" className="space-y-4">
                            <Card className="bg-black/40 backdrop-blur-sm border-green-900/50">
                                <CardHeader>
                                    ...
                                    <CardDescription>Your latest challenge completions and achievements</CardDescription>
                                </CardHeader>
                                    ...
                                    {recentCompletions.map((completion) => (
                                        <div key={completion.id} className="flex items-center gap-4 p-4 rounded-lg bg-black/20">
                                            ...
                                            <div className="flex-1">
                                                <p className="font-medium">Completed Challenge</p>
