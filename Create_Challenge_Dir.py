...
Running script creates a new challenge directory with incrementing challenge number and copies content from template 
challenge.py and solution.py


challenge_i/
│   │   ├── challenge_i.py  # Script to generate the challenge
...
def create_challenge_structure(base_dir="challenges", challenge_template="challenges/template/challenge_template.py",
    ...
    print(f"New challenge created: Challenge_{next_challenge_number}")
