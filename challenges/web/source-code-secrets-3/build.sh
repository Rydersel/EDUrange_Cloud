...
docker buildx build --platform linux/amd64 -t registry.rydersel.cloud/source-code-secrets-3 . --push

if [ $? -eq 0 ]; then
    echo "Build and push successful!"
    echo "Challenge image: registry.rydersel.cloud/source-code-secrets-3"
else
