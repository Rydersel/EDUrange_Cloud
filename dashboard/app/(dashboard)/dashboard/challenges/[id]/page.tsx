...
export default async function ChallengeDetailPage(props: ChallengeDetailPageProps) {
  ...
  const breadcrumbItems = [
    { title: 'Installed Challenges', link: '/dashboard/challenges' },
    { title: challenge.name, link: `/dashboard/challenges/${challenge.id}` }
  ];
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-primary/10 p-4 rounded-lg flex flex-col items-center justify-center">
                <span className="text-2xl font-bold text-foreground">{challenge.questions.length}</span>
            ...
            <div className="p-4 bg-muted rounded-md">
              <h3 className="text-sm font-medium mb-2">Challenge Image</h3>
        ...
        <Tabs defaultValue="questions" className="w-full">
          <TabsList>
            ...
            <TabsTrigger value="appConfigs" className="flex items-center">
              ...
              App Configurations ({challenge.appConfigs.length})
            </TabsTrigger>
          </TabsList>
            ...
            <Card>
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {challenge.appConfigs.map((config) => (
