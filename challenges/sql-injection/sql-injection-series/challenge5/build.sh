...
docker buildx build --platform linux/amd64 -t registry.edurange.cloud/challenges/sql-injection-challenge5 . --push

if [ $? -eq 0 ]; then
    echo "Build and push successful!"
    echo "Challenge image: registry.edurange.cloud/challenges/sql-injection-challenge5"
    echo ""
